...
pathSonLinuxSidetectar = model_path = os.path.join(current_directory, 'Sound',
                                                   'detectando.mp3')  # "/home/nicov/Desktop/TFG/mano_detectada.mp3"
pathSonLinuxNodetectar = model_path = os.path.join(current_directory, 'Sound',
                                                   'Nodetectando.mp3')  # "/home/nicov/Desktop/TFG/mano_detectada.mp3"
pathWindows = model_path = os.path.join(current_directory, 'Model',
...
# FunciÃ³n para convertir o texto a voz en tempo real
...
while True:
        ...
        for handLms in resultado.multi_hand_landmarks:
            ...
            if cx < region_x_max and cy < region_y_max:
                if not hand_detected:
                    ...
                    if not ctrDetect:
                        texto = "Cambiando a deteccion"
                        pathSonLinux = pathSonLinuxSidetectar
                    else:
                        texto = "Sin detectar"
                        pathSonLinux = pathSonLinuxNodetectar
    ...
    if ctrDetect:
        ...
        # Debuxar as anotaciÃ³ns na imaxe en branco
        for r in resultados:
            boxes = r.boxes
            for box in boxes:
